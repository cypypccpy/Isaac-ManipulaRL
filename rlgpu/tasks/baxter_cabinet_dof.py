...
class BaxterCabinet(BaseTask):
    ...
    def pre_physics_step(self, actions):
        if self.demostration_round < 1:
            ...
            self.baxter_dof_targets[:, self.baxter_begin_dof:self.num_baxter_dofs] = targets / 3.14 * (self.baxter_dof_upper_limits[self.baxter_begin_dof:] - self.baxter_dof_lower_limits[self.baxter_begin_dof:]) / 2 + (self.baxter_dof_upper_limits[self.baxter_begin_dof:] + self.baxter_dof_lower_limits[self.baxter_begin_dof:]) / 2
            self.baxter_dof_targets[:, self.baxter_begin_dof:self.num_baxter_dofs] = tensor_clamp(
                self.baxter_dof_targets[:, self.baxter_begin_dof:self.num_baxter_dofs], self.baxter_dof_lower_limits[self.baxter_begin_dof:], self.baxter_dof_upper_limits[self.baxter_begin_dof:])
